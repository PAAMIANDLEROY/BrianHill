...
# dz1 -> number of choices -> urn point in dz1 if urn chosen in both cases
# both not the urn -> the bag -> dz2
# first choice bag, second choice urn -> az1
# first choice urn, second choice bag -> az2

def algo(useWhile=True, *algovars):
    ...
    returnAtEachBet = True
    retrunOnlyAtLogs = True
    if (not useReturn): returnAtEachBet = False
